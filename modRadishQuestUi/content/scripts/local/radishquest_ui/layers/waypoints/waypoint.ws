// ----------------------------------------------------------------------------
class CRadishQuestLayerWaypoint extends CRadishLayerEntitySetMember {
    // ------------------------------------------------------------------------
    default entityType = "waypoint";
    // ------------------------------------------------------------------------
    default proxyTemplate = "engine\templates\editor\markers\review\opened_flag.w2ent";
    // ------------------------------------------------------------------------
    protected var settings: SRadishLayerWaypointData;
    // ------------------------------------------------------------------------
    ...
    public function cloneFrom(src: CRadishLayerEntity) {
        ...
        newSettings = ((CRadishQuestLayerWaypoint)src).getSettings();
