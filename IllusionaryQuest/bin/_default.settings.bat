...
rem target root directory for all uncooked textures to be cooked
set DIR_UNCOOKED_TEXTURES=%DIR_PROJECT_BASE%\textures
rem set DIR_UNCOOKED_TEXTURES=%DIR_PROJECT_BASE%\uncooked
...
:CheckScriptsDir
if exist "%DIR_MODKIT_DEPOT%\scripts\dlc%MODNAME%" GOTO :NoError
